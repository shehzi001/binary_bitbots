...
//! (velocity-based interface, minimum synchronization time)
//! \n
//! \n
//! \n
//! Reflexxes GmbH\n
...
// specifying a minimum synchronization time.
...
int main()
{
	...
	printf("This example demonstrates the specification of a       \n"	);
	printf("minimum synchronization time for the velocity-based    \n"	);
	printf("Online Trajectory Generation algorithm of the Type IV  \n"	);
