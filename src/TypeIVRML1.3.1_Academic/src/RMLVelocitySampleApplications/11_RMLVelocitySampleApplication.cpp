//  ---------------------- Doxygen info ----------------------
//! \file 11_RMLVelocitySampleApplication.cpp
//!
//! \brief
//! Test application number 11 for the Reflexxes Motion Libraries
...
int main()
{
	...
	printf("Example: 11_RMLVelocitySampleApplication               \n\n");
	...
	// ReflexxesAPI::RMLVelocity() returns the error value -108 
