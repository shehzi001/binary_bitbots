//  ---------------------- Doxygen info ----------------------
//! \file 10_RMLPositionSampleApplication.cpp
//!
//! \brief
//! Test application number 10 for the Reflexxes Motion Libraries
...
int main()
{
    ...
    printf("Example: 10_RMLPositionSampleApplication               \n\n");
    ...
    printf("Based on Example 9, this example shows the             \n"  );
