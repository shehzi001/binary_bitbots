//  ---------------------- Doxygen info ----------------------
//! \file 15_RMLPositionSampleApplication.c
//!
//! \brief
//! Test application number 15 for the Reflexxes Motion Libraries
//! (C-wrapper, target position-based algorithm)
//! \n
//! \n
//! \n
//! Reflexxes GmbH\n
...
int main()
{
    ...
    double						CurrentPositionVector		[NUMBER_OF_DOFS]
							...
							,	MaxVelocityVector			[NUMBER_OF_DOFS]
							,	MaxAccelerationVector		[NUMBER_OF_DOFS]
							,	MaxJerkVector				[NUMBER_OF_DOFS]
							,	TargetPositionVector		[NUMBER_OF_DOFS]
    ...
    printf("Example: 15_RMLPositionSampleApplication               \n\n");
    printf("This example demonstrates the most basic use of the    \n"  );
    printf("C-wrapper for the Reflexxes API using the position-    \n"  );
    printf("based Type IV Online Trajectory Generation algorithm.  \n"  );
    printf("It is based on Example 1.                              \n\n");
    ...
    CurrentPositionVector		[0]	=	 100.0		;
    CurrentPositionVector		[1]	=	   0.0		;
    CurrentPositionVector		[2]	=	  50.0		;
    
    CurrentVelocityVector		[0]	=	 100.0		;
    CurrentVelocityVector		[1]	=	-220.0		;
    CurrentVelocityVector		[2]	=	 -50.0		;
    
    CurrentAccelerationVector	[0]	=	-150.0		;
    CurrentAccelerationVector	[1]	=	 250.0		;
    CurrentAccelerationVector	[2]	=	 -50.0		;	

    MaxVelocityVector			[0]	=	 300.0		;
    MaxVelocityVector			[1]	=	 100.0		;
    MaxVelocityVector			[2]	=	 300.0		;
    
    MaxAccelerationVector		[0]	=	 300.0		;
    MaxAccelerationVector		[1]	=	 200.0		;
    MaxAccelerationVector		[2]	=	 100.0		;		

    MaxJerkVector				[0]	=	 400.0		;
    MaxJerkVector				[1]	=	 300.0		;
    MaxJerkVector				[2]	=	 200.0		;
    
    TargetPositionVector		[0]	=	-600.0		;
    TargetPositionVector		[1]	=	-200.0		;
    TargetPositionVector		[2]	=	-350.0		;
    
    TargetVelocityVector		[0]	=	 50.0		;
    TargetVelocityVector		[1]	=	-50.0		;
    TargetVelocityVector		[2]	=  -200.0		;
    ...
    while (ResultValue != 1)
    {
        ...
        ResultValue	=	TypeIVRMLPosition(		CurrentPositionVector
